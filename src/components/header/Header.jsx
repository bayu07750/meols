  ...
  return (
    <header className="h-[400px] overflow-hidden relative">
      <div className="relative z-10 h-full w-full flex flex-col items-center justify-center">
        <h1 className="text-white dark:text-gray-300 font-extrabold text-center text-4xl sm:text-4xl lg:text-5xl sm:max-w-2xl lg:max-w-none px-4 sm:px-0">
          Temukan makanan atau sekedar melihat
        </h1>
        <div className="hidden lg:block text-white dark:text-gray-300 mt-4 max-w-xl text-center">
